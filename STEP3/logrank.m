function [p,dAUC,AUC1,AUC2] = logrank(x1,x2,txt1,txt2,c1,c2,varargin)
...
% clf
hold on
S1=stairs(t1,T1,c1); %Kaplan-Meier curve for treatment 1
if ~isempty(table12)
...
S2=stairs(t2,T2,c2); %Kaplan-Meier curve for treatment 2
if ~isempty(table22)
